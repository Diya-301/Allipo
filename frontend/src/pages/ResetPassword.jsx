        ...
        <div className="w-full max-w-md p-4 sm:p-6 md:p-8 bg-white shadow-2xl rounded-2xl relative overflow-hidden transition-transform duration-300 hover:scale-105">
          ...
          <div className="relative z-10">
            ...
            <form onSubmit={handleSubmit}>
              <input
                type="password"
                className="w-full p-2 sm:p-3 md:p-4 border border-gray-300 rounded-lg focus:outline-none focus:ring-2 focus:ring-indigo-500 transition-all duration-300 mb-3 sm:mb-4 md:mb-6 text-sm sm:text-base"
              ...
              <button
                type="submit"
                className="w-full bg-gradient-to-r from-indigo-500 to-purple-500 text-white py-2 sm:py-3 md:py-4 rounded-lg font-semibold hover:opacity-90 transition-all duration-300 relative overflow-hidden text-sm sm:text-base"
                disabled={isLoading}
              >
                {isLoading ? (
